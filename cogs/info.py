...
class Information:
    ...
    async def eightball(self, ctx, *, question=None):
        ...
        emb.set_author(name='Your question:', icon_url=author.avatar_url)
    ...
    async def about(self, ctx):
        ...
        embed.add_field(name='Owner', value='Liam#3273', inline = False)
        embed.add_field(name='Owner ID', value='300944772971888640', inline = False)
        embed.add_field(name='My Coding Sensei\'s ID', value='280271578850263040\nThank You', inline = False)
