...
Originally by Liam  Quanta#5556 (N)
...
class Gen:
    ...
    async def invite(self,ctx):
        ...
        em.add_field(name = "Thank You For Choosing Me", value = """Join my **Support Server** if you would like to know more about me or show your support.\nServer Link: https://discord.gg/k3PKut6 """, inline = True)
