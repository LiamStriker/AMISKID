...
class Gen:
    ...
    async def invite(self,ctx):
        ...
        em = discord.Embed(title = "Click Here For Invite Link", url = "https://discordapp.com/oauth2/authorize?client_id=381111258172227585&scope=bot&permissions=305196166")
