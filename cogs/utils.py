...
8.Ami/ami :
    Talk to me (^~^) start your sentence with Ami/ami

9.op8ball :
    See your future

10.opserverlist :
     Shows the list of servers I am in (^~^)

**Music Commands:**
 Music Prefix : /

1. /summon: before using.

2. /play [song]: play the song.

3. /repeat: toggle repeat modes.

4. /queue: songs in queue.

5. /volume [value]: set volume.

6. /promote [number]: put song to top.

7. /disconnect [always do.]
 ```
        """
        await ctx.send("**PREFIX = op** ***AND*** **MUSIC PREFIX = /*** "+help_cmd)
