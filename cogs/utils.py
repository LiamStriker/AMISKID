...
class Utility:
    ...
    async def help(self, ctx, *, args = None):
        ...
        if args is None:
            ...
            miscellaneous = "`cmd`,`8ball`,`gif`,`Talk to me`\nActions:`kiss`,`hug`,`bite`,`slap`"
            ...
            em.add_field(name = '**2.Misc:**', value = miscellaneous, inline = False)
            em.add_field(name = '**3.Mod:**', value = mod, inline = False)
            em.add_field(name = '**4.Music:**', value = music, inline = False)
            em.add_field(name = '**5.Expanded Help:**', value = expand, inline = False)
            em.add_field(name = '**6.Support Me~**', value = support, inline = False)
            ...
            em = discord.Embed()
            em.set_thumbnail(url = "https://cdn.discordapp.com/attachments/388676126383276032/390477398287843329/images_5.jpg")
            em.set_author(name = 'Misc Help~',icon_url = ctx.author.avatar_url )
